...
CREATE TABLE `showtimes` (
  ...
  `hall_id` varchar(2) NOT NULL,
  `movie_id` int NOT NULL,
  PRIMARY KEY (`show_id`),
  KEY `hall_id` (`hall_id`),
  KEY `movie_id` (`movie_id`),
  CONSTRAINT `showtimes_ibfk_1` FOREIGN KEY (`hall_id`) REFERENCES `auditorium` (`hall_id`),
  CONSTRAINT `showtimes_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`movie_id`)
